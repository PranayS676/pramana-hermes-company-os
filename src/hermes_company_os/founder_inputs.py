...
def founder_input_request_markdown(
    ...
    lines.extend(
        [
            ...
            "",
            "- Paste completed reply template: `/setup#input-import`",
            "- Safe dashboard inputs: `/setup#inputs`",
            "- External credential status only: `/setup#secret-status`",
...
def founder_input_request_json(
    ...
    payload = {
        ...
        "entry_points": {
            "reply_import": "/setup#input-import",
