        ...
        "phase_order": [
            {
                ...
                "order": 1,
                "dashboard_anchor": "/setup/profiles#profile-installation-tracking",
                "requirements": [],
            ...
            },
            {
                ...
                "order": 2,
                "dashboard_anchor": "/setup/messaging#secret-status",
            ...
            },
            {
                ...
                "order": 5,
                "dashboard_anchor": "/setup/profiles#profile-smoke",
...
def credential_loading_markdown(**kwargs) -> str:
    ...
    lines.extend(
        [
            ...
            "LLM credentials.",
            "- Import no-secret audit output at `/setup/profiles#profile-installation-tracking`.",
    ...
    lines.extend(
        [
            ...
            "urgent Telegram delivery in `/setup/messaging#messaging-verification`.",
    ...
    lines.extend(
        [
            ...
            "Run profile smoke checks at `/setup/profiles#profile-smoke` only after the "
    ...
    lines.extend(
        [
            ...
            "- Import status metadata at `/setup/messaging#credential-status-import`.",
